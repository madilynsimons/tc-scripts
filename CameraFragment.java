...
public class CameraFragment extends Fragment
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            final ImagePickerActivity mActivity = ((ImagePickerActivity) getActivity());

            mActivity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    if (deviceOrientation == Surface.ROTATION_90) {
                        try {
                    ...
                    mActivity.addImage(Uri.parse(mFile.getAbsolutePath()));
                }
            });
    ...
    /**
     * The last recorded time when the shutter button was clicked
     */
...
//        mFile = new File(getActivity().getExternalFilesDir(null), System.currentTimeMillis()+"_capture.jpg");
        ...
        SimpleOrientationListener mOrientationListener = new SimpleOrientationListener(
                ((ImagePickerActivity) getActivity())) {
            @Override
            public void onSimpleOrientationChanged(int orientation) {
                if(orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    deviceOrientation = Surface.ROTATION_90;
                    System.out.println("LANDSCAPE GAGOOOOOOOOOOOOOOOOOOOOOO");
                }
                else if (orientation == Configuration.ORIENTATION_PORTRAIT) {
                    deviceOrientation = 0;
                    System.out.println("PORTRAIT GAGOOOOOOOOOOOOOOOOOOOOOO");
                }
            }
        };
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance("TraffickCam requires camera permissions.")
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage("TraffickCam requires camera permissions.")
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
