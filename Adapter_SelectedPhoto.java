...
public class Adapter_SelectedPhoto extends BaseRecyclerViewAdapter<Uri, Adapter_SelectedPhoto.SelectedPhotoHolder> {
    ...
    public SelectedPhotoHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.simons.owner.traffickcam2.R.layout.picker_list_item_selected_thumbnail, parent, false);
    ...
    class SelectedPhotoHolder extends RecyclerView.ViewHolder {
        ...
        public SelectedPhotoHolder(View itemView) {
            super(itemView);
            selected_photo = (ImageView) itemView.findViewById(com.simons.owner.traffickcam2.R.id.selected_photo);
            iv_close = (ImageView) itemView.findViewById(com.simons.owner.traffickcam2.R.id.iv_close);
