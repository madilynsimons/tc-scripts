...
public class Config {
    ...
    private int toolbarTitleRes = com.simons.owner.traffickcam2.R.string.toolbar_title;
    ...
    private int cameraHeight = com.simons.owner.traffickcam2.R.dimen.ted_picker_camera_height;

    private int cameraBtnImage = com.simons.owner.traffickcam2.R.drawable.ic_camera;
    private int cameraBtnBackground = com.simons.owner.traffickcam2.R.drawable.btn_bg;

    private int selectedCloseImage = com.simons.owner.traffickcam2.R.drawable.ic_clear;
    private int selectedBottomHeight = com.simons.owner.traffickcam2.R.dimen.ted_picker_selected_image_height;

    private int savedDirectoryName = com.simons.owner.traffickcam2.R.string.default_directory;
